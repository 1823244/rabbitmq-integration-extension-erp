...
Функция ЗагрузкаДанныхИзФайлов_ОдинКаталогФТП(РежимЗагрузки, МаскаФайлов, ВыводитьСообщения, КаталогФТП, session, ГруппаНастроекПВХ = Неопределено, Лог = Неопределено) Экспорт
	...
	|ИЗ
	|	ВтФайлы КАК ВтФайлы
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗагрузкаДанныхИзФулфилмент КАК Рег
...
Процедура СозданиеДокументовДвиженияКМ(ГруппаНастроекПВХ = Неопределено, Лог = Неопределено)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ЗагрузкаДанныхИзФулфилмент.ДанныеФайла КАК ДанныеФайла,
		|	ЗагрузкаДанныхИзФулфилмент.ИмяФайла КАК ИмяФайла,
		|	ЗагрузкаДанныхИзФулфилмент.ИмяРазархивированногоФайла КАК ИмяРазархивированногоФайла
		|ИЗ
		|	РегистрСведений.ЗагрузкаДанныхИзФулфилмент КАК ЗагрузкаДанныхИзФулфилмент
		|ГДЕ
		|	ЗагрузкаДанныхИзФулфилмент.СтатусДанных В (&СтатусыДанных)";
