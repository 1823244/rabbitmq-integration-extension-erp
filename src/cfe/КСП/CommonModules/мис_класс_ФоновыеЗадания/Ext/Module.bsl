...
//		
//		Если мис_Функции.МожноВыполнитьВФоне(Отладка) Тогда
...
Процедура ДобавитьФоновоеЗадание(ИДВызова, ИмяПроцедуры, МассивПараметров, Задача, ЕстьЗаписи, Ключ =Неопределено) Экспорт
	...
	Если НЕ мис_Функции.МожноВыполнитьВФоне(Отладка) Тогда
	...
	Исключение
		...
		обработки.мис_Logger._ОписаниеОшибки(ИнформацияОбОшибке()));
