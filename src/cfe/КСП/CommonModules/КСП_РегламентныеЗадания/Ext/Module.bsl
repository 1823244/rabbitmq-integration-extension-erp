...
//
// Параметры
//	ЭлементСправочника - СправочникОбъект.КСП_УправлениеЗаданиями - группа справочника
//	Расписание
//	ОбщиеПараметры
//	
Процедура СоздатьРегламентноеЗадание(ЭлементСправочника,Расписание,ОбщиеПараметры=Неопределено) Экспорт
	...
	//Если ПараметрыСеанса.КСП_ЭтоСервернаяБаза = Ложь Тогда
	//	ЗаписьЖурналаРегистрации("КСП_РеглЗадания",УровеньЖурналаРегистрации.Предупреждение,
	...
	Ключ = КСП_УправлениеЗаданиямиСервер.СформироватьУникальныйКлючЗадания(ЭлементСправочника.Ссылка);
	...
	Иначе
		//Задание = РегламентныеЗадания.СоздатьРегламентноеЗадание("КСП_Планировщик");
...
Процедура УдалитьРегламентноеЗадание(ЭлементСправочника) Экспорт
	...
	массивЗаданий = РегламентныеЗадания.ПолучитьРегламентныеЗадания(
		Новый Структура("Ключ",
				КСП_УправлениеЗаданиямиСервер.СформироватьУникальныйКлючЗадания(ЭлементСправочника.Ссылка))
	);
