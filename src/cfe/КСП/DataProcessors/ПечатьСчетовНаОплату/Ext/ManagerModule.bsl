...
Процедура КСП_ЗаполнитьТабличныйДокументСчетаНаОплату(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, ПараметрыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Иначе
			...
			ИтоговаяСтрока = СтрЗаменить(ИтоговаяСтрока, "%Сумма%",           ФормированиеПечатныхФорм.ФорматСумм(СуммаКПрописи - ДанныеПечати.Ссылка.КСП_СуммаЗачетаПредоплаты, ДанныеПечати.Валюта));
			Если ПечататьРасшифровкуПоТоварамСПредоплатой Тогда
				ИтоговаяСтрока = СтрЗаменить(ИтоговаяСтрока, "%СуммаПредоплаты%", ДанныеПечати.Ссылка.КСП_СуммаЗачетаПредоплаты);
			КонецЕсли;
			...
			Иначе
				Если ПечататьРасшифровкуПоТоварамСПредоплатой Тогда
					СтруктураДанныхСуммаПрописью.Вставить("СуммаПрописью", РаботаСКурсамиВалютУТ.СформироватьСуммуПрописью(
																			СуммаКПрописи - ДанныеПечати.Ссылка.КСП_СуммаЗачетаПредоплаты, 
																			ДанныеПечати.Валюта));
				Иначе
