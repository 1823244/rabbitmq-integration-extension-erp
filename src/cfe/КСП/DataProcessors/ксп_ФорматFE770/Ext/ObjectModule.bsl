...
Функция ЗагрузкаДанныхКМНаФулфилменте_FE770(ЧтениеXML, ПолноеИмяФайла, ИмяФайла, пЛог) Экспорт
	...
	//ЕНС
	ОбработатьКоды(labelsRequest, ТаблицаДанных);	
	...
	//ЕНС
	ОбработатьРезультатЗапроса(РезультатЗапроса, ПолноеИмяФайла);
...
// Заполняет таблицу в параметре ТаблицаДанных
//
// Параметры:
//	Параметр1 	- Тип1 - 
//
Процедура ОбработатьКоды(labelsRequest, ТаблицаДанных)
...
//	Параметр1 	- Тип1 - 
//
Процедура ОбработатьРезультатЗапроса(РезультатЗапроса, ПолноеИмяФайла)
