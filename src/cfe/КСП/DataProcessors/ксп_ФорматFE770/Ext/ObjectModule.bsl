		...
		Пока ВыборкаВидПродукции.Следующий() Цикл
			...
			Пока ВыборкаЗаказ.Следующий() Цикл
				...
				Если ДокументОбъект.ДвиженияКодовМаркировки.Количество() = 1 Тогда
					...
					ЗапросЗаказ.УстановитьПараметр("ДатаПоДаннымКлиента",ДокументОбъект.ДатаЗаказа);
					...
					Пока ВыборкаДанныеЗаказа.Следующий() Цикл
						...
						ДокументОбъект.ДвиженияКодовМаркировки[0]["Характеристика"] = ВыборкаДанныеЗаказа.Характеристика;
					КонецЦикла;
				КонецЕсли;
