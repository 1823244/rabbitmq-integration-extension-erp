...
Функция ТекущийУровеньЛогов() Экспорт
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	КСП_УровеньЛогов.Уровень КАК Уровень
		|ИЗ
		|	РегистрСведений.КСП_УровеньЛогов КАК КСП_УровеньЛогов";
...
НаборЗаписей = РегистрыСведений.КСП_УровеньЛогов.СоздатьНаборЗаписей();
