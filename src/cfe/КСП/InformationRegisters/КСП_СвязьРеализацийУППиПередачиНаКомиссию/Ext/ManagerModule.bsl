...
//	
//
Процедура ДобавитьЗапись(ВнешняяСистема, ГУИД,ЗаказКлиента,РеализацияТоваровУслуг,РасходныйОрдерНаТовары, ПредставлениеРТУ,Комментарий) Экспорт
	...
	НовСтр.РеализацияТоваровУслуг = РеализацияТоваровУслуг;
