...
Функция ПоМэппингу(GUID, ВнешняяСистема) Экспорт
	...
	Запрос.Текст = 
		...
		|ИЗ
		|	РегистрСведений.ксп_МэппингСправочникКассыККМ КАК Рег
		|ГДЕ
		|	Рег.GUID = &GUID
...
Процедура ДобавитьГУИД(GUID, Наименование, ВнешняяСистема) Экспорт
	...
	НЗ = РегистрыСведений.ксп_МэппингСправочникКассыККМ.СоздатьНаборЗаписей();
...
Процедура ДобавитьЗапись(GUID, Наименование, ВнешняяСистема, КассаККМ) Экспорт
