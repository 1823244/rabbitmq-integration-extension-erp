...
Процедура СоздатьЗаданиеВСправочнике(Наименование, ИмяМетода, ТЗПараметры, Родитель = Неопределено, СледующаяПроцедура = Неопределено) Экспорт
	...
	Если МассивЗаданий.Количество() = 0 Тогда
		Эл 							= Справочники.КСП_УправлениеЗаданиями.СоздатьЭлемент();
...
Функция СоздатьГруппуЗаданий(Наименование, СледующаяПроцедура = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ГруппаСсылка) Тогда
		...
		ГруппаОбъект 					= Справочники.КСП_УправлениеЗаданиями.СоздатьГруппу();
...
//ТЗПараметры 	= КСП_УправлениеЗаданиямиСервер.НоваяТаблицаЗначенийПараметровЗадания();
...
Функция НайтиГруппуЗаданийПоНаименованию(Наименование) Экспорт
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	КСП_УправлениеЗаданиями.Ссылка КАК Ссылка
		|ИЗ
		|	Справочник.КСП_УправлениеЗаданиями КАК КСП_УправлениеЗаданиями
		|ГДЕ
		|	КСП_УправлениеЗаданиями.Наименование = &Наименование
		|	И КСП_УправлениеЗаданиями.ЭтоГруппа = &ЭтоГруппа";
...
Функция НайтиЭлементЗаданийПоИмениМетода(ИмяМетода) Экспорт
	...
	Запрос.Текст =
		...
		|	Справочник.КСП_УправлениеЗаданиями КАК КСП_УправлениеЗаданиями
		|ГДЕ
		|	выразить(КСП_УправлениеЗаданиями.ПроцедураСПараметрами как строка(500)) = &ИмяМетода
		|	И КСП_УправлениеЗаданиями.ЭтоГруппа = &ЭтоГруппа";
