...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) И ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда
		...
		Если ТипЗнч(РасписаниеЗадания) <> Тип("РасписаниеРегламентногоЗадания") Тогда
			...
			РасписаниеЗадания = КСП_УправлениеЗаданиямиКлиентСервер.ИнициализацияРасписания();
		Иначе
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	//
	//КСП_РегламентныеЗадания.ПередЗаписьюЭлементаСправочникаЗаданий(ТекущийОбъект,ПараметрыЗаписи.РасписаниеЗадания);
...
Процедура Заполнить(Команда)
	Рез  = ОткрытьФормуМодально("Справочник.КСП_УправлениеЗаданиями.ФормаВыбора");
...
Процедура ПараметрыПроцедурыЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	Если ТипЗнч(Элементы.ПараметрыПроцедуры.ТекущиеДанные.Значение) = Тип("СписокЗначений") Тогда
		...
		Значение = ОткрытьФормуМодально("Справочник.КСП_УправлениеЗаданиями.Форма.ФормаСпискаЗначений",ПараметрыФормы);
