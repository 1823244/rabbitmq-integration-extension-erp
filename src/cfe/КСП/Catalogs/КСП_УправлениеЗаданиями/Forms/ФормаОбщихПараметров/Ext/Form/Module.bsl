...
Процедура Запуск(Команда)
	...
	Оповестить("Запущена группа справочника КСП_УправлениеЗаданиями");
...
Функция КонстантыОбщихПараметров()
	...
	Для Каждого Стр Из ТЗ Цикл
		Если Стр.ТипПараметра = "СписокЗначений" Тогда
			ПустоеЗначениеТипа = КСП_УправлениеЗаданиямиОбщегоНазначенияСервер.ПолучитьПустоеЗначениеТипа(Тип(Стр.ТипЗначенияСписка));
		Иначе
			ПустоеЗначениеТипа = КСП_УправлениеЗаданиямиОбщегоНазначенияСервер.ПолучитьПустоеЗначениеТипа(Тип(Стр.Типпараметра));
		КонецЕсли;
